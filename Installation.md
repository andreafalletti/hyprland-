# Foreword
NVIDIA GPUs in ANY capacity are NOT supported, but you may ask for some help around on the [Discord server](https://discord.gg/hQ9XvMUjjr), people have been running Hyprland on NVIDIA with success.
